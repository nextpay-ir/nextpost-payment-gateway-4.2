                                    ...
                                    <div class="options">
                                        ...
                                        <div class="option-group none payment-gateways" style="margin-bottom:45px">
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <?php if ($Integrations->get("data.nextpay.api_key") ): ?>
                                                    <input class="" name="payment-apikey" type="hidden" value="<?php echo $Integrations->get('data.nextpay.api_key') ?>">
                                                    <div class="option-group-item">
                                                        <label>
                                                            <input class="custom-radio" name="payment-gateway" type="radio" value="nextpay" data-recurring="<?= $Integrations->get("data.nextpay.recurring") ? "true" : "false" ?>">
                                                            <div>
                                                                <div class="text-c">
                                                                    <img src="<?= APPURL."/assets/img/cc/nextpay.png" ?>" alt="Visa">
                                                                </div>
                                                            </div>
                                                        </label>
                                                    </div>
