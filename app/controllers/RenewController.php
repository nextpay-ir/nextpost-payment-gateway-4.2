...
class RenewController extends Controller
{
    ...
    public function pay()
    {
        ...
        if ($ActivePackage->isAvailable()) {
            ...
            /*$converted_res = ($AuthUser->get("package_subscription")) ? 'true' : 'false';
            echo '<script>console.log("'.$converted_res.'")</script>';*/
        ...
        try {
            ...
            if($payment_gateway == "nextpay"){
                $this->resp->msg = $url['msg'];
                $this->resp->url = $url['url'];
                $this->resp->result = $url['result'];
                $this->jsonecho();
