...
(2, 'integrations', '{"dropbox":{"api_key":""},"google":{"api_key":"","client_id":"","analytics":{"property_id":""}},"onedrive":{"client_id":""},"paypal":{"client_id":"","client_secret":"","environment":"sandbox"},"nextpay":{"api_key":""},"stripe":{"environment":"sandbox","publishable_key":"","secret_key":""},"facebook":{"app_id":"","app_secret":""}}'),
